...
const NoteModal = ({ onClose, note, setNote }) => {
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-[#fffdfb] p-6 rounded-xl shadow-xl border border-[#e5d2b2] w-[420px] relative animate-fadeIn">
        <button onClick={onClose} className="absolute top-3 right-3 text-[#8b4513] hover:text-[#b86b36] text-2xl transition">
          ×
        </button>
        ...
        <textarea
          placeholder="Nhập ghi chú chi tiết, ví dụ: Bao bì sản phẩm lỗi..."
          value={note}

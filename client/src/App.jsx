...
//thêm
import ThongKe from "./pages/QuanLyKhoThanhPham/ThongKe.jsx";
import KiemDinhQC from "./pages/QuanLyKhoThanhPham/KiemDinhQC.jsx";
import XuatKhoThanhPham from "./pages/QuanLyKhoThanhPham/XuatKhoThanhPham.jsx";
// --- QC routes
...
=======
      ...
      {/* Warehouse product pages (linked from Sidebar) */}
      <Route
        path="/NhapKhoThanhPham"
        element={
          <ProtectedRoute allowedRoles={["warehouseproduct"]}>
            <NhapKhoThanhPham />
          </ProtectedRoute>

...
import { Bell, Settings, User, Home, PackagePlus, PackageMinus } from "lucide-react";
import { useState } from "react";

const KhoNVLLayout = () => {
  const [active, setActive] = useState("nhapKho");
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-2 cursor-pointer hover:bg-[#c97a44] px-3 py-1 rounded-lg transition-all">
              ...
              <div className="text-right text-sm">
                ...
                <div className="text-xs text-yellow-200">Quản lý kho NVL</div>
              </div>
            </div>
          </div>
        </header>

...
router.get("/", verifyToken, authorizeRoles(["orders","plan","director"]), controller.getAllOrders);
router.get("/pending", verifyToken, authorizeRoles(["orders","plan","director"]), controller.getPendingOrders);
...
// Update order
router.put("/:id", verifyToken, authorizeRoles(["orders","director"]), controller.updateOrder);
